 ...
 *
 *  cmd  "del": delete model;<br>"que": query model;
 *  authid: user id ,can be @"tianxia" or other;
 *  pwdt voiceprint type<br>
 ...
 *  vid  another voiceprint type model,user can use this to query or delete model in server can be @"jakillasdfasdjjjlajlsdfhdfdsadff",totally 32 bits;<br>
 *  NOTES:<br>
